                    ...
                    <OwlCarousel className="offer-slider dark-nav owl-carousel"  {...mainBannerOptions}>
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3>
                                    ...
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>Toronto Tour</Link>
                                </h3>
                        ...
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3><i className="flaticon-arrival" />
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>Centre Island, Toronto</Link>
                                </h3>
                        ...
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3><i className="flaticon-arrival" />
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>Royal Ontario Museum, Toronto</Link>
                                </h3>
                                <strong>$150 <span>$200</span></strong>
                            </div>
                        </div>
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3><i className="flaticon-arrival" />
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>CN Tower Tour</Link>
                                </h3>
                                <strong>$150 <span>$200</span></strong>
                            </div>
                        </div>
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3><i className="flaticon-arrival" />
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>Ontario Science Centre</Link>
                                </h3>
                                <strong>$170 <span>$200</span></strong>
                            </div>
                        </div>
                        <div className="offer-card">
                            ...
                            <div className="offer-details">
                                ...
                                <h3><i className="flaticon-arrival" />
                                    <Link to={`${process.env.PUBLIC_URL}/package-details`}>Casa Loma, Toronto</Link>
                                </h3>
                                <strong>$150 <span>$200</span></strong>
                            </div>
                        </div>
